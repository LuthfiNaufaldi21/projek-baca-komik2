...
  const { updateReadingHistory, isLoggedIn } = useAuth(); // 👈 Ambil isLoggedIn
...
  // 4. Update History (Integrasi API)
  useEffect(() => {
    if (comicId && chapterId && isLoggedIn) { // 👈 KUNCI: Tambahkan Pengecekan isLoggedIn
      // Panggil fungsi async dari context
...
  }, [comicId, chapterId, isLoggedIn]); // 👈 Tambahkan isLoggedIn ke dependencies
