...
  const avatarColor = getAvatarColor(user?.username || "User");
  ...
  // 🎯 KODE PERBAIKAN: Membangun Full URL Avatar (Hapus '/api' dari Base URL)
...
                <div 
                    ...
                    style={{
                        // 🎯 PERBAIKAN: Gunakan fullAvatarUrl sebagai background
...
                    </div>
                  ) : (
                    // Tampilkan ikon default hanya jika user TIDAK login DAN TIDAK ada URL Avatar
                    // Jika user login TAPI punya avatar, kita tidak merender apa-apa di sini
                    isLoggedIn && fullAvatarUrl ? null : ( 
                        <svg
