...
-- 6. Tabel Reading History (Mencatat SETIAP chapter)
CREATE TABLE public.read_history (
  ...
  -- Mencegah duplikasi history chapter yang sama untuk user yang sama
  constraint unique_chapter_read unique (user_id, comic_id, chapter_slug)
);
